...
const BulkCreateDemandsDialog: React.FC<BulkCreateDemandsDialogProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(val) => { if(!val) resetForm(); onOpenChange(val); }}>
      <DialogContent className="w-[95vw] max-w-2xl backdrop-blur-md bg-white/95 dark:bg-gray-900/95 shadow-2xl flex flex-col max-h-[90vh] p-0 overflow-hidden border border-white/20">
        ...
        <DialogFooter className="p-6 border-t bg-background/80 backdrop-blur-md">
